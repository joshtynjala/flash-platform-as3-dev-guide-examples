package com.example.programmingas3.clock
{
    ...
    import com.example.programmingas3.shared.component.SampleInput;
    ...
    import flash.display.StaticText;
    import flash.events.*;
	 ...
	 */
    public class AnalogClockFace extends SampleComponent 
    {
    	/**
        ...
        */
        public function drawHand(hand:Shape, distance:uint, color:uint, thickness:Number)
        {
